...
BOARD_SUPER_PARTITION_PRODUCT_DEVICE_SIZE := 419430400
BOARD_SUPER_PARTITION_METADATA_DEVICE := system
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3556769792
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 394264576
BOARD_SUPER_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_PRODUCT_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE) )

BOARD_SUPER_PARTITION_GROUPS := a10_dynpart
BOARD_A10_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_A10_DYNPART_PARTITION_LIST := system system_ext product vendor odm
